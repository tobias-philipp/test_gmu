...
Pod::Spec.new do |s|
  s.name             = 'GMapUtils'
  s.version          = '0.1.0'
  s.summary          = 'A short description of GMapUtils.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/xpureTobias/GMapUtils'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'xpureTobias' => 't.philipp@xpure.de' }
  s.source           = { :git => 'https://github.com/xpureTobias/GMapUtils.git', :tag => s.version.to_s }
